...
equation by its whole \`$$...$$\` token. Match a standalone image block by
its complete markdown image token or its source URL. Images beside text are
not matched by URL, to avoid deleting the surrounding text.
...
Deleting a standalone image by its source URL:
    { "postId": "...", "key": "...", "prefix": "https://example.com/image.png", "mode": "edit" }
