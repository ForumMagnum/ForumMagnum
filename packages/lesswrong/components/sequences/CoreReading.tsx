...
const coreReadingCollections: Array<CoreReadingCollection> = isEAForum ?
  [
    ...
    },
    {
      ...
      summary: "Nate Soares writes about replacing guilt with other feelings and finding better ways to self-motivate, so that you can build a better future without falling apart first.",
