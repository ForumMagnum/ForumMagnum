  ...
  return <div className="sequences-grid-item" >
    ...
    <div className="sequences-grid-item-bottom">
      <div className="sequences-grid-item-image">
        <NoSSR><Image publicId={sequence.gridImageId || "sequences/vnyzzznenju0hzdv6pqb.jpg"} dpr="auto" responsive={true} sizes="100vw" cloudName="lesswrong-2-0" quality="auto" height={124} width={315} crop="fill" gravity="custom" client_hints="true"/></NoSSR>
      </div>
    </div>
  </div>;
};
