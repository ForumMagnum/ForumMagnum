...
// dialog.
const AFNonMemberPopup = ({secondWarning=false, onClose, classes}: {
  ...
  const { tag } = useTagBySlug(secondWarning ? "af-non-member-popup-second" : "af-non-member-popup-first", "TagFragment")
    ...
    >
      <Card className={classes.popupCard}>
        ...
        <Button className={classes.understandConfirmation} onClick={() => {
          void updateCurrentUser({hideAFNonMemberWarning: true})
