...
const ModerationActionButtons = ({user, currentUser, addToUndoQueue}: {
  ...
  const moderatorActionButtons = [
    ...
    {
      label: 'Reject Latest and Remove',
      keystroke: 'X',
    ...
    {
      label: 'Reject, Restrict, and Notify',
      keystroke: 'Shift+R',
  ...
  return (
    <div className={classes.actionsColumn}>
      {moderatorActionButtons.map(({label, keystroke, tooltip, onClick}) => (
        <LWTooltip key={label} title={tooltip} placement="left" className={classes.actionTooltip}>
          <div className={classes.actionRow} onClick={onClick}>
            <span>{label}</span>
