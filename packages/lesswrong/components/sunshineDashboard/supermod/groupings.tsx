 ...
 * 4. STRICTER_COMMENT_AUTOMOD_RATE_LIMIT, STRICTER_POST_AUTOMOD_RATE_LIMIT (keeping up with joneses)
 * 5. SNOOZE_EXPIRED (snooze expired)
 */
...
export type TabId = ReviewGroup | 'all' | 'posts' | 'classifiedPosts' | 'autoRejected' | 'pangram' | 'curation';
