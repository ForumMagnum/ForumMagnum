            ...
            <div className={classNames(classes.column, classes.mt60)}>
              ...
              <div className={classNames(classes.row, classes.mt20)}>
                ...
                <ElectionFundCTA
                  ...
                  href="https://forum.effectivealtruism.org/posts/hAzhyikPnLnMXweXG/participate-in-the-donation-election-and-the-first-weekly#Start_discussions_on_where_we_should_donate__what_we_should_vote_for__and_other_questions_related_to_effective_giving"
                >
                  <Link
