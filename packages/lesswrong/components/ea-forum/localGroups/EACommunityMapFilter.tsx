...
import { ArrowSVG, GroupIconSVG } from '../../localGroups/Icons'
import qs from 'qs'
...
interface EACommunityMapFilterProps extends ExternalProps, WithLocationProps, WithNavigationProps, WithDialogProps, WithUserProps, WithUpdateCurrentUserProps, WithMessagesProps, WithStylesProps {
}
interface EACommunityMapFilterState {
  filters: any,
}

class EACommunityMapFilter extends Component<EACommunityMapFilterProps,EACommunityMapFilterState> {
  constructor(props: EACommunityMapFilterProps) {
    super(props);
  ...
  render() {
    const { classes, openDialog, currentUser, showHideMap, toggleGroups, showGroups, toggleEvents, showEvents, history } = this.props;
...
const EACommunityMapFilterComponent = registerComponent<ExternalProps>('EACommunityMapFilter', EACommunityMapFilter, {
  styles,
  hocs: [
...
declare global {
  interface ComponentTypes {
    EACommunityMapFilter: typeof EACommunityMapFilterComponent
  }
}
