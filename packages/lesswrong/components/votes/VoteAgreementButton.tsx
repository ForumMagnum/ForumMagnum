...
import {VoteButtonProps} from "./VoteButton";
...
const VoteAgreementButtonComponent = registerComponent('VoteAgreementButton', VoteAgreementButton, {
  styles,
  hocs: [withTheme()]
});
...
declare global {
  interface ComponentTypes {
    VoteAgreementButton: typeof VoteAgreementButtonComponent
  }
}
