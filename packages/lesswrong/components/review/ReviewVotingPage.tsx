...
const ReviewVotingPage = ({classes}: {
  ...
  const instructions = isEAForum ?
    ...
    <div className={classes.instructions}>
      ...
      <p>This year, we're beginning with Preliminary Voting. Posts with at least one positive vote will appear in the public list to the right. You are encouraged to vote on as many posts as you have an opinion on.</p>
