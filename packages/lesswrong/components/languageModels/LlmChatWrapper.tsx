...
import type { ClientMessage, PromptContextOptions, RagModeType } from './schema';
...
const LlmChatWrapper = ({children}: {
  ...
  // Because we're not fetching the list of conversations during SSR, the `conversations` state
