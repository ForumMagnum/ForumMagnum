...
export const ChatInterface = () => {
  ...
  const { currentConversation, setCurrentConversation, archiveConversation, orderedConversations, submitMessage, currentConversationLoading, orderedConversationsLoading } = llmInterface;
