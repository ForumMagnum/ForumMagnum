...
const FriendlyPostVersionHistoryButton = ({post, postId, classes}: {
  post: PostsBase,
  postId: string,
  classes: ClassesType
}) => {
  ...
  return <EAButton
    onClick={() => {
      ...
      openDialog({
        componentName: "FriendlyPostVersionHistory",
...
const FriendlyPostVersionHistory = ({post, postId, onClose, classes}: {
  post: PostsBase,
  postId: string,
  onClose: () => void,
...
const FriendlyPostVersionHistoryEAButton = registerComponent("FriendlyPostVersionHistoryButton", FriendlyPostVersionHistoryButton, {styles});
const FriendlyPostVersionHistoryComponent = registerComponent("FriendlyPostVersionHistory", FriendlyPostVersionHistory, {styles});

declare global {
  interface ComponentTypes {
    FriendlyPostVersionHistoryButton: typeof FriendlyPostVersionHistoryEAButton
    FriendlyPostVersionHistory: typeof FriendlyPostVersionHistoryComponent
  }
}
