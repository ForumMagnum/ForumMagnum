...
const PostShareAndImport = ({document, formType, value, classes}: {
  formType: "edit"|"new",
...
const PostShareAndImportComponent = registerComponent('PostShareAndImport', PostShareAndImport, {styles});

declare global {
  interface ComponentTypes {
    PostShareAndImport: typeof PostShareAndImportComponent,
  }
}
