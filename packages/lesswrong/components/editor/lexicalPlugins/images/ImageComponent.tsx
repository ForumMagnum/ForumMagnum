...
// import EmojisPlugin from '@lexical/react/LexicalEmojisPlugin';
// import KeywordsPlugin from '@lexical/react/LexicalKeywordsPlugin';
import { LinkPlugin } from '@lexical/react/LexicalLinkPlugin';
// import MentionsPlugin from '../mentions/MentionPlugin';
              ...
              <RichTextPlugin
                contentEditable={
                  <ContentEditable
                    ...
                    placeholder={<div className="ImageNode__placeholder">Enter a caption...</div>}
                    className="ImageNode__contentEditable"
                  />
                }
                ErrorBoundary={LexicalErrorBoundary}
              />
              {/* {showNestedEditorTreeView === true ? <TreeView editor={editor} /> : null} */}
