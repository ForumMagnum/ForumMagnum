...
import { ButtonGroup, DropdownMenu, DropdownMenuButton, SimpleDropdown } from '@proton/components'
    ...
    >
      {!isSuggestionMode && (
        <Button icon shape="ghost" size="small" onClick={fitTableToPageWidth} disabled={isSuggestionMode}>
          <span className="sr-only">Fit table to page width</span>
          <ForumIcon icon="ArrowsUpDown" />
        </Button>
      )}
      {!isSuggestionMode && (
        <SimpleDropdown
        ...
        >
          <DropdownMenu>
            ...
            >
              <ForumIcon icon="Palette" />
              <span className="mr-1">Header row</span>
              <ToggleSwitch className="pointer-events-none ml-auto" value={tableHasHeaderRow} />
            </DropdownMenuButton>
            <DropdownMenuButton
              className="flex items-center gap-2.5 text-sm"
              onClick={() => {
            ...
            >
              ...
              <ToggleSwitch className="pointer-events-none ml-auto" value={tableHasHeaderColumn} />
            </DropdownMenuButton>
          </DropdownMenu>
        </SimpleDropdown>
      )}
