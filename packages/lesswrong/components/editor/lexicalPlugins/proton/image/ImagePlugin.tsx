...
import { downSize } from '../utils/image'
import { captureException } from '@/lib/sentryWrapper'
import { isImage } from '../utils/mimetype'
import { $canDropImage, $getImageNodeInSelection, getDragImageData, getDragSelection } from './ImageUtils'
import { INSERT_FILE_COMMAND } from '../utils/commands'
import { SupportedMimeTypes } from '../utils/constants'
  ...
  useEffect(() => {
    ...
    return mergeRegister(
      ...
      editor.registerCommand<InsertImagePayload>(
        INSERT_FILE_COMMAND,
        (payload) => {
          // TODO: we're going to be uploading it to cloudinary, so we don't care about checking locally
          ...
          void handleDownsizingAndInsert().catch(captureException)
          return true
        },
        COMMAND_PRIORITY_EDITOR,
      ),
      ...
      editor.registerCommand(
        ...
        ({ nodes, selection }) => {
          ...
          void convertSourcesAndInsertNodes().catch(captureException)
          return true
        },
        COMMAND_PRIORITY_LOW,
      ),
