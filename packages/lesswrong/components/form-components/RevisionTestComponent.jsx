...
class RevisionTestComponent extends Component {
...
RevisionTestComponent.contextTypes = {
  updateCurrentValues: PropTypes.func,
  addToSuccessForm: PropTypes.func,
};
registerComponent("RevisionTestComponent", RevisionTestComponent, withStyles(styles, { name: "RevisionTestComponent" }));
