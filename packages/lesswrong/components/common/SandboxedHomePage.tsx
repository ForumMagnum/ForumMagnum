...
const styles = defineStyles('SandboxedHomePage', (theme: ThemeType) => ({
  ...
  customizeButton: {
    ...
    color: '#000000',
    border: 'none',
    boxShadow: '1px 1px 0 #ffffff inset, -1px -1px 0 #808080 inset, 2px 2px 0 #dfdfdf inset, -2px -2px 0 #404040 inset',
    ...
    '&:active': {
      boxShadow: '1px 1px 0 #808080 inset, -1px -1px 0 #ffffff inset, 2px 2px 0 #404040 inset, -2px -2px 0 #dfdfdf inset',
      paddingTop: 4,
      paddingLeft: 17,
      paddingBottom: 2,
      paddingRight: 15,
