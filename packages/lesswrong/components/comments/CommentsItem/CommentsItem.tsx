...
export const CommentsItem = ({
  ...
  const { postPage, tag, post, refetch, hideReply, showPostTitle, singleLineCollapse, hideReviewVoteButtons } =
    treeOptions;
  ...
  return (
    <AnalyticsContext pageElementContext="commentItem" commentId={comment._id}>
      <div
        className={classNames(classes.root, "recent-comments-node", {
      ...
      >
        ...
        <div className={classes.titleRow}>
          ...
          {showPostTitle && !isChild && hasTagField(comment) && comment.tag && (
            <Link className={classes.postTitle} to={tagGetUrl(comment.tag)}>
              {comment.tag.name}
            </Link>
          )}
        </div>
        <div className={classes.body}>
          <div className={classes.meta}>
            ...
            />
            {comment.moderatorHat && <span className={classes.moderatorHat}>Moderator Comment</span>}
            ...
            {comment.reviewingForReview && (
              <Link to={`/reviews/${comment.reviewingForReview}`} className={classes.metaNotice}>
                {`Review for ${
          ...
          {comment.promoted && comment.promotedByUser && (
            <div className={classes.metaNotice}>Promoted by {comment.promotedByUser.displayName}</div>
          )}
          {renderBodyOrEditor()}
