...
import { tagGetCommentLink, tagGetUrl } from "../../../lib/collections/tags/helpers";
    ...
    <AnalyticsContext pageElementContext="commentItem" commentId={comment._id}>
      <div className={classNames(
        ...
        <div className={classes.titleRow}>
          ...
          {showPostTitle && !isChild && hasTagField(comment) && comment.tag && <Link className={classes.postTitle} to={tagGetCommentLink({tagSlug: comment.tag.slug, tagCommentType: comment.tagCommentType})}>{comment.tag.name}</Link>}
        </div>
