...
const PinToProfileMenuItem = ({ comment, classes }: {
  comment: CommentsList, classes: ClassesType,
}) => {
  ...
  const stickyIcon = <svg className="MuiSvgIcon-root MuiListItemIcon-root" fill="currentColor" height="15" viewBox="0 0 10 15" width="10" xmlns="http://www.w3.org/2000/svg">
  ...
  return <MenuItem onClick={setPinned}>
    <ListItemIcon>
      {stickyIcon}
    </ListItemIcon>
    Pin to profile
