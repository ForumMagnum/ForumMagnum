...
const CommentsDraftListItem = ({comment, classes}: {
  ...
  const {
    LWPopper, LWTooltip, UsersName, CommentsNode, UsersNameDisplay
  } = Components;
...
const CommentsDraftListItemComponent = registerComponent(
...
declare global {
  interface ComponentTypes {
    CommentsDraftListItem: typeof CommentsDraftListItemComponent,
  }
}
