...
export const DialoguesNewForm = ({classes}: {
  classes: ClassesType,
}) => {
...
const DialoguesNewFormComponent = registerComponent('DialoguesNewForm', DialoguesNewForm, {styles});

declare global {
  interface ComponentTypes {
    DialoguesNewForm: typeof DialoguesNewFormComponent
  }
}
