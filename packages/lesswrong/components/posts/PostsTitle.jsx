...
const PostsTitle = ({currentUser, post, classes, sticky, read, expandOnHover, location, tooltip=true, showQuestionTag=true, wrap=false}) => {
...
registerComponent('PostsTitle', PostsTitle, withUser, withRouter,
