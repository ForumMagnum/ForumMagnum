...
import { Components, registerComponent, getFragment, withMessages, withCurrentUser, withList } from 'meteor/vulcan:core';
...
registerComponent('PostsEditForm', PostsEditForm, withMessages, withRouter, withCurrentUser, [withList, categoryListOptions]);
