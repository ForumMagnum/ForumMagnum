...
export const T3AudioPlayer = ({showEmbeddedPlayer, postId, className, classes}: {
  ...
  >
    <div className={classNames(className, classes.embeddedPlayer, { [classes.hideEmbeddedPlayer]: !showEmbeddedPlayer })}>
      {type3scriptLoaded && (
        /* @ts-ignore */
