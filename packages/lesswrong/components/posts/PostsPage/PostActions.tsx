...
const PostActions = ({post, closeMenu, classes}: {
  ...
  const { MoveToDraft, BookmarkButton, SuggestCurated, SuggestAlignment, ReportPostMenuItem, DeleteDraft, SubscribeTo, NominatePostMenuItem, ReviewVotingWidget } = Components
  if (!post) return null;
