...
const PostsTopSequencesNav = ({post, classes}: {
  ...
  const { LWTooltip, SequencesSummary, SequencesNavigationLink } = Components;
  ...
  return (
    <div className={classes.root}>
      ...
      <LWTooltip tooltip={false} title={<SequencesSummary sequence={post.sequence} />} clickable={true}>
