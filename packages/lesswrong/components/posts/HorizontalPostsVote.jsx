...
class HorizontalPostsVote extends PureComponent {
  render() {
    ...
    return (
        <div className={classes.voteBlock}>
          ...
          <span className={classes.voteScores}>
            <Tooltip
...
registerComponent('HorizontalPostsVote', HorizontalPostsVote,
  withStyles(styles, { name: "HorizontalPostsVote" })
);
