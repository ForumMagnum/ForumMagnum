...
export const stickyIcon = (className?: string) => <svg className={className ?? ''} fill="currentColor" height="15" viewBox="0 0 10 15" width="10" xmlns="http://www.w3.org/2000/svg">
