...
export const JargonEditorRow = ({classes, postId, jargonTerm, instancesOfJargonCount}: {
  ...
  return <div className={classes.root}>
      ...
      : <div className={classNames(classes.explanationContainer, !jargonTerm.approved && classes.unapproved)} onClick={() => setEdit(true)}>
          <JargonTooltip term={jargonTerm.term} definitionHTML={jargonDefinition} altTerms={jargonTerm.altTerms ?? []} humansAndOrAIEdited={jargonTerm.humansAndOrAIEdited} replacedSubstrings={[]} clickable={false} placement="bottom-end">
