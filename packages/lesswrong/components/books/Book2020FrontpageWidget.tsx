...
const Book2020FrontpageWidgetInner = ({ classes }: {
...
const Book2020FrontpageWidgetComponent = registerComponent('Book2020FrontpageWidget', Book2020FrontpageWidgetInner, { styles });
