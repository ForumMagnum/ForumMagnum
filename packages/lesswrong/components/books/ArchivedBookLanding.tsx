  ...
  return (
    <div>
      ...
      <div className={classes.colorQuoteContainer}>
        <div className={classNames(classes.bigColorQuote, classes.coloredBand)} style={{"color": color}}>
          {quote}
        </div>
  ...
  return (
    <div className={classes.root}>
      ...
      {colorBandAndQuote({classes,
        ...
        quote: 'The essays from [...] LessWrong have been one of my favorite sources of wisdom [...] Especially in our rapidly changing world, these writings are among those that I expect will continue to be read many decades from now.',
        quoteAuthor: 'Vitalik Buterin'
      })}
      ...
      {colorBandAndQuote({classes,
        ...
        quote: 'Whenever there’s a cutting-edge new idea making the rounds, Eliezer was writing about it 5-10 years ago. A deep dive into LessWrong will make you smarter.',
