...
const OldUsersEditForm = ({terms, classes}: {
...
const OldUsersEditFormComponent = registerComponent('OldUsersEditForm', OldUsersEditForm, {styles});

declare global {
  interface ComponentTypes {
    OldUsersEditForm: typeof OldUsersEditFormComponent
  }
}
