...
const UserWithLinesIcon = ({hasFill, ...props}: React.HTMLAttributes<SVGElement> & {
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path d="M16 8L23 8" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
      <path d="M15 11L23 11" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
      <path d="M18 14L23 14" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
    </svg>
  );
}
