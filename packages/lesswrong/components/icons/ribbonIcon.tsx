...
export const RibbonIcon = ({className}: {className?: string}) => <svg xmlns="http://www.w3.org/2000/svg" id="Icons" viewBox="0 0 60 60" className={className}>
  <defs>
    <filter filterUnits="objectBoundingBox" id="pencilTexture5">
      ...
      {/* <feTurbulence type="turbulence" baseFrequency="0.03" numOctaves="5" seed="10" result="f2">
      </feTurbulence>
      <feDisplacementMap xChannelSelector="R" yChannelSelector="G" scale="5" in="SourceTextured" in2="f2" result="f5">
      </feDisplacementMap>
      <feTurbulence type="turbulence" baseFrequency="0.03" numOctaves="5" seed="100" result="f3">
      </feTurbulence>
