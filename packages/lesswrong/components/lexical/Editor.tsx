...
const styles = defineStyles('LexicalEditor', (theme: ThemeType) => ({
  ...
  editorContainer: {
    ...
    '& .llm-content-block:has(> .llm-content-block-content > p:last-child) .llm-content-block-content > p:last-child::after': {
      content: '"⊙"',
    ...
    '& .llm-content-block .llm-content-block-content > p:last-child:has(> br:only-child)': {
      display: 'inline-block',
      margin: 0,
      minWidth: '0.6em',
    },
    '& .llm-content-block .llm-content-block-content > p:last-child:has(> br:only-child) > br:only-child': {
      display: 'none',
    },
    '& .llm-content-block .llm-content-block-content > p:last-child:has(> br:only-child)::after': {
      content: '"⊙"',
      display: 'inline-block',
      color: theme.palette.greyAlpha(0.55),
      fontSize: '0.85em',
    ...
    '& .llm-content-block:not(:has(> .llm-content-block-content > p:last-child)) .llm-content-block-content::after': {
      content: '"⊙"',
      display: 'block',
      width: 'fit-content',
      color: theme.palette.greyAlpha(0.55),
