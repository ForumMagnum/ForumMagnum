...
const RecentDiscussionCommentThread = ({
  post,
  comments,
  refetch,
  ...
  return (
    <AnalyticsContext pageSubSectionContext='recentDiscussionCommentThread'>
...
const RecentDiscussionCommentThreadComponent = registerComponent(
  'RecentDiscussionCommentThread', RecentDiscussionCommentThread, {
    styles,
...
declare global {
  interface ComponentTypes {
    RecentDiscussionCommentThread: typeof RecentDiscussionCommentThreadComponent,
  }
}
