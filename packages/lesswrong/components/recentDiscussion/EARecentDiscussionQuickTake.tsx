...
import type { NonnullCommentTreeNode } from "../../lib/utils/unflatten";
...
const getItemProps = (
  ...
  {item}: NonnullCommentTreeNode<RecentDiscussionCommentsList>,
...
type NestedComments = NonnullCommentTreeNode<RecentDiscussionCommentsList>;
    ...
    <>
      {splitComments.map((comments) => {
        ...
        const quickTake = hasComments
          ? comments[0].item.ancestorComments?.[0]
          : comments[0].item;
        if (!quickTake) {
          return null;
        }
