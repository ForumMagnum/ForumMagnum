...
const clearStyle = (theme: ThemeType) => ({
  ...
  '.PostsPage-postContent.ContentStyles-postBody, .CommentBody-root.ContentStyles-commentBody, .CommentBody-root.ContentStyles-commentBody blockquote, .CommentBody-root.ContentStyles-commentBody li, .LWPopularComment-body, .LWQuickTakesCollapsedListItem-body': {
    fontFamily: [
      'warnock-pro',
      'Palatino',
      '"Palatino Linotype"',
