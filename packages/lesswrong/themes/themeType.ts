...
declare global {
  ...
  type ThemeComponentPalette = {
    ...
    panelBackground: {
      ...
      sunshineNewContentGroup: string,
    ...
    lexicalEditor: {
      ...
      codeHighlight: {
        tokenComment: ColorString,
        tokenDeleted: ColorString,
        tokenInserted: ColorString,
        tokenUnchanged: ColorString,
        tokenPunctuation: ColorString,
        tokenProperty: ColorString,
        tokenSelector: ColorString,
        tokenOperator: ColorString,
        tokenAttr: ColorString,
        tokenVariable: ColorString,
        tokenFunction: ColorString,
      },
    },
    blockquoteHighlight: {
