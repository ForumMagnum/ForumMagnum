...
export const recombeeDatabaseIdSetting = new DatabaseServerSetting<string | null>('recombee.databaseId', null);
export const recombeePublicApiTokenSetting = new DatabaseServerSetting<string | null>('recombee.publicApiToken', null);
