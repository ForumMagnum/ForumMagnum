...
function fragmentToInterface(context: TypeGenerationContext, interfaceName: string, parsedFragment: ParsedFragmentType, collection: AnyBecauseTodo): string {
  const sb: Array<string> = [];
...
export function getFragmentFieldType(context: TypeGenerationContext, namePrefix: string, parsedSelector: AnyBecauseTodo, collection: AnyBecauseTodo):
