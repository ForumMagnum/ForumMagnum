import { getAllFragmentNames, getFragment, getCollectionName, getCollection, getAllCollections, isValidCollectionName, getAdditionalSchemas } from '../../lib/vulcan-lib';
...
import type { GraphQLNamedType, DocumentNode, ASTNode } from 'graphql';
