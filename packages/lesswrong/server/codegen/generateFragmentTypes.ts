...
function fragmentToInterface(interfaceName: string, parsedFragment: ParsedFragmentType | FieldNode, collection: CollectionBase<CollectionNameString> | null): string {
  const sb: Array<string> = [];
