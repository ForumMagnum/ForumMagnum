...
const NewDialogueMessages = ({documentId, userId}: {
  documentId: string,
  userId: string,
  classes: any,
}) => {
...
const NewDialogueMessagesComponent = registerComponent("NewDialogueMessages", NewDialogueMessages);

declare global {
  interface ComponentTypes {
    NewDialogueMessages: typeof NewDialogueMessagesComponent
  }
}
