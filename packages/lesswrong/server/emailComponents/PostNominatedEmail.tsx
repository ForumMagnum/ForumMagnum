...
const PostNominatedEmail = ({documentId, reason}: {
  ...
  return (<React.Fragment>
    <p>Your post <a href={postGetPageUrl(post)}>{post.title}</a> has received multiple positive votes for the {REVIEW_NAME_IN_SITU}! On {nominationEndDate.format('MMM Do')}, the nomination vote results will be published, and will be used to help prioritize the Review Phase.</p>
