...
export const EmailCuratedAuthors = ({ user, post, emailContext }: {
  user: DbUser;
  post: DbPost;
  ...
  return (
    <div className={classes.root}>
      ...
      <p>
        ...
        We were impressed with your post, <a href={postGetAbsolutePageUrl(post, emailContext.resolverContext.forumType)} className={classes.link}>{post.title}</a>,
