...
registerComponent("EmailListOfUsers", EmailListOfUsers);
...
registerComponent("PrivateMessagesEmailConversation", PrivateMessagesEmailConversation,
  withStyles(styles, {name: "PrivateMessagesEmailConversation"}));
