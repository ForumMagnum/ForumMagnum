...
// is a dictionary from A/B test names to which test branch the render is for.
// Only A/B tests which actually mattered are included.
//
...
const cachedABtestsIndex: Record<string,Array<Record<string,string>>> = {};
