...
registerMigration({
  ...
  dateWritten: "2023-04-02",
  idempotent: true,
  action: async () => {
    for (const row of acxData) {
      let eventOrganizer
      // Figure out whether user with email address already exists
      // SKY TODO: This used to be userFindByEmail from /lib/vulcan-users/helpers. That seems to have become userFindOneByEmail from /lib/collections/users/commonQueries, but you should check that those actually behaved the same.
      ...
      if (existingUser) {
        ...
        const { data: newUser } = await createMutator({
          ...
          document: {
            ...
            reviewedByUserId: "XtphY3uYHwruKqDyG", //SKY TODO: This looks like a hardcoded user who supposedly reviewed something. Who is that user?
            reviewedAt: new Date()
          },
          validate: false,
          currentUser: null
      ...
      // Then create event post with that user as owner, if it doesn't have an Event Link already
      
      const title = `${row["City"]} – ACX Meetups Everywhere Spring 2023 `
      const existingPost = "Event Link" in row
      if (!existingPost) {
        const newPostData = {
          title,
          postedAt: new Date(),
          ...
          location: `${row["City"]}`,
          startTime: eventTimePretendingItsUTC.getTime() ? row["Time"] : undefined,
          ...
          contents: {
            originalContents: {
              ...
              data: `<p>This year's ACX Meetup everywhere in ${row["City"]}.</p>
                <p>Location: ${row["Location description"]} – <a href="https://plus.codes/${row["Pluscodes"]}">${row["Pluscodes"]}</a></p>
        ...
        // eslint-disable-next-line no-console
        console.log("Meetup already had an event link: ", title)
      }
    }
  }
})
...
const acxData = [
    {
       ...
       },
       {
        ...
        "City": "West Palm Beach, Florida, U.S.A.",
       ...
       },
       {
        ...
        "City": "Sunnyvale, California (South Bay SF area)",
       ...
       },
       {
        ...
        "Date": "04\/29\/2023",
        "Time": "7:00:00 PM",
        "Event Link": "Facebook: https:\/\/www.facebook.com\/events\/562820449276368 ; LessWrong:  https:\/\/www.lesswrong.com\/events\/DRrEn7GDz8GksBdMR\/washington-dc-acx-mini-meetups-everywhere-spring-2023",
        "Notes": "Group Info:  The Washington DC ACX\/SSC group has been active since the first Meetups Everywhere in 2017. We have socials, hikes, board game days, and other cultural events. We've collaborated with other nearby groups on EA topic focused discussions and rationality Dojo-type events. New public facebook group link:https:\/\/www.facebook.com\/groups\/605023464809227\/",
       ...
       },
       {
        ...
        "Email address": "pvillalobos at proton dot me",
       ...
       },
       {
        ...
        "City": "West Lafayette, Indiana, United States",
       ...
       },
       {
        ...
        "Notes": "Note: Also counts as Waterloo, Ontario",
       ...
       },
       {
        ...
        "Time": "7:00:00 PM",
        "Event Link": "https:\/\/www.lesswrong.com\/events\/356ktNDSxLzbcG2Lc\/acx-spring-meetups-everywhere",
        "Notes": "Note: Also counts as Kitchener, Ontario",
        "GPS Coordinates": "43.452687,-80.486438"
       },
       {
        "Region": "Europe",
       ...
       },
       {
        ...
        "City": "Belgrade, Serbia, Europe, World",
       ...
       {
        "Region": "North America",
        "Name\/initials\/handle": "Jack",
        "Email address": "gallerdude@gmail.com",
        "City": "Twin Cities, Minnesota, USA",
        "Location description": "Surly Brewery. Guy wearing and handing out Hawaiian Lei’s",
        "Plus.Code Coordinates": "https:\/\/plus.codes\/86P8XQFR+53",
        "Date": "04\/15\/2023",
        "Time": "12:30:00 PM",
        "GPS Coordinates": "44.972938,-93.209812"
       },
       {
        "Region": "North America",
