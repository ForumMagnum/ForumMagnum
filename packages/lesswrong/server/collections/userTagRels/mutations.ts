...
const wrappedUpdateFunction = wrapUpdateMutatorFunction('UserTagRels', updateFunction, {
  editCheck,
  accessFilter: (rawResult, context) => accessFilterSingle(context.currentUser, 'UserTagRels', rawResult, context)
});
...
export const graphqlUserTagRelTypeDefs = gql`
  ...
  extend type Mutation {
    ...
    updateUserTagRel(selector: SelectorInput!, data: UpdateUserTagRelDataInput!): UserTagRel
  }
`;
