...
export async function createReviewWinner({ data }: { data: Partial<DbInsertion<DbReviewWinner>> }, context: ResolverContext) {
...
export async function updateReviewWinner({ selector, data }: { selector: SelectorInput, data: Partial<DbInsertion<DbReviewWinner>> }, context: ResolverContext) {
