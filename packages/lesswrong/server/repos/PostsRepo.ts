...
export default class PostsRepo extends AbstractRepo<DbPost> {
  ...
  getDialogueResponseCount = (post:DbPost) => {
    ...
    const dummyHtml = `
    <block blockId="ireiha-83484r7" submitted-at="2023-10-04T13:00:00.000Z">
    ...
    <block blockId="iasdvphiue264r7 submitted-at=""2023-10-04T13:00:00.000Z"">
  ...
  const ids : string[] = blocksWithId.map( (i, block) => parsedHtml(block).attr('blockid')).get();
