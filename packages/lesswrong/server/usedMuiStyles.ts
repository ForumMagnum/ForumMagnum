...
const getUsedMuiStyles = () => {
  const components = {
    ...
    MuiDialogActions: require("@/lib/vendor/@material-ui/core/src/DialogActions/DialogActions").styles,
    MuiDialogContent: require("@/lib/vendor/@material-ui/core/src/DialogContent/DialogContent").styles,
    ...
    MuiTable: require("@/lib/vendor/@material-ui/core/src/Table/Table").styles,
    MuiTableBody: require("@/lib/vendor/@material-ui/core/src/TableBody/TableBody").styles,
    MuiTableCell: require("@/lib/vendor/@material-ui/core/src/TableCell/TableCell").styles,
    MuiTableRow: require("@/lib/vendor/@material-ui/core/src/TableRow/TableRow").styles,
