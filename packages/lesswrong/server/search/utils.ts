...
Users.toAlgolia = async (user: DbUser): Promise<Array<AlgoliaUser>|null> => {
  ...
  const algoliaUser: AlgoliaUser = {
    ...
    htmlHowOthersCanHelpMe: user.htmlHowOthersCanHelpMe?.slice(0, USER_BIO_MAX_SEARCH_CHARACTERS),
    howICanHelpOthers: user.howICanHelpOthers?.slice(0, USER_BIO_MAX_SEARCH_CHARACTERS),
    htmlHowICanHelpOthers: user.htmlHowICanHelpOthers?.slice(0, USER_BIO_MAX_SEARCH_CHARACTERS),
    karma: user.karma,
    slug: user.slug,
