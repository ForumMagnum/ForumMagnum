import { defineMutation, defineGqlQuery } from '../utils/serverGraphqlUtil';
...
defineGqlQuery({
  ...
  fn: async (root: void, args: void, context: ResolverContext): Promise<NotificationCountsResult> => {
