...
export const exampleJargonGlossary = `[{"term": "Alpha Fold", "definition": "DeepMind's AI system for protein structure prediction"},
{"term": "Alpha Proteo", "definition": "DeepMind's AI system for designing proteins that bind to target molecules"},
{"term": "superforecaster", "definition": "Someone exceptionally skilled at making accurate predictions about future events"},
{"term": "Apple Intelligence", "definition": "Apple's upcoming AI assistant and features"},
{"term": "jailbreak", "definition": "To bypass an AI system's safety restrictions or intended limitations"},
{"term": "multimodal", "definition": "Able to process and generate multiple types of data like text, images, audio etc."},
{"term": "procedural generation", "definition": "Using algorithms to create content automatically"},
{"term": "circuit breakers", "definition": "Safety mechanisms designed to halt or restrict AI systems in certain scenarios"},
{"term": "Reflection-Tuning", "definition": "A claimed technique for enabling AI models to recognize and fix their own mistakes"},
{"term": "SB 1047", "definition": "A California bill aimed at regulating powerful AI models"},
{"term": "deepfake", "definition": "Synthetic media in which a person's likeness is replaced with someone else's"},
{"term": "AGI", "definition": "Artificial General Intelligence - AI with human-level general intelligence"},
{"term": "ASI", "definition": "Artificial Superintelligence - AI far surpassing human intelligence"},
{"term": "p(doom)", "definition": "Probability of existential catastrophe from AI"},
{"term": "p(heaven)", "definition": "Probability of extremely positive outcomes from AI"}]`