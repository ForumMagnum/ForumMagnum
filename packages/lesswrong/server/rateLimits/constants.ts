...
export const autoPostRateLimits: ForumOptions<AutoRateLimit<'Posts'>[]> = {
  EAForum: [POSTS.FIVE_PER_DAY],
  LessWrong: [POSTS.FIVE_PER_DAY_UNDER_500_KARMA, POSTS.TWO_PER_WEEK_LOW_KARMA, POSTS.ONE_PER_WEEK_NEGATIVE_KARMA, POSTS.ONE_PER_TWO_WEEKS_VERY_NEGATIVE_KARMA],
  default: [POSTS.FIVE_PER_DAY]
};

export const autoCommentRateLimits: ForumOptions<AutoRateLimit<'Comments'>[]> = {
  EAForum: [COMMENTS.ONE_PER_EIGHT_SECONDS, COMMENTS.FOUR_PER_THIRTY_MINUTES_LOW_KARMA, COMMENTS.FOUR_PER_THIRTY_MINUTES_DOWNVOTE_RATIO],
  LessWrong: [COMMENTS.ONE_PER_EIGHT_SECONDS, COMMENTS.THREE_PER_DAY_LOW_KARMA, COMMENTS.ONE_PER_DAY_NEGATIVE_KARMA, COMMENTS.ONE_PER_THREE_DAYS_VERY_NEGATIVE_KARMA],
  default: [COMMENTS.ONE_PER_EIGHT_SECONDS]
};
