...
export function ckEditorDocumentIdToPostId(ckEditorId: string) {
...
export async function getStorageDocument(ckEditorId: string) {
...
export async function getAllStorageDocuments() {
...
export async function getCollaborationDetails(documentId: string) {
  return await fetchCkEditorRestAPI("GET", `/collaborations/${documentId}/details`);
}

export async function getAllConnectedUserIds(documentId: string) {
...
export async function getAllRevisionsForDocument(ckEditorId: string) {
  return await fetchCkEditorRestAPI("GET", `/revisions?document_id=${ckEditorId}&order=desc`); 
}

export async function fetchCkEditorCommentThread(threadId: string): Promise<CkEditorComment[]> {
...
export async function fetchCkEditorUser(userId: string): Promise<CkEditorUser | undefined> {
  let parsedUser;
  try {
...
export async function flushAndUpgradeCkEditorCollaboration(ckEditorId: string) {
...
export async function flushAndUpgradeAllCkEditorCollaborations() {
  const collaborations = JSON.parse(await getAllCollaborations());
  for (let ckEditorId of collaborations) {
    try {
      await flushAndUpgradeCkEditorCollaboration(ckEditorId);
    } catch(e) {
      // eslint-disable-next-line no-console
      console.error(e);
    }
 ...
 */
export async function restoreCkEditorCollaboration(ckEditorId: string) {
 ...
 */
export async function deleteCkEditorCloudStorageDocument(ckEditorId: string) {
...
export async function createCkEditorUser(user: { id: string; name: string; }): Promise<string> {
  return await fetchCkEditorRestAPI("POST", `/users`, user);
}

export async function createCollaborativeSession(ckEditorId: string, html: string) {
...
export async function createCkEditorDocument(payload: CreateDocumentPayload) {
  return await fetchCkEditorRestAPI("POST", "/documents", payload);
}

export async function uploadEditorBundle(bundleVersion: string): Promise<void> {
  if (!bundleVersion)
...
export async function checkEditorBundle(bundleVersion: string): Promise<{ exists: boolean }> {
  if (!bundleVersion)
    throw new Error("Missing argument: bundleVersion");
...
export async function fetchCkEditorCloudStorageDocumentHtml(ckEditorId: string): Promise<string> {
  ...
  try {
    ...
    const document = await fetchCkEditorDocumentFromStorage(ckEditorId);
...
export async function pushRevisionToCkEditor(postId: string, html: string) {
  ...
  await deleteCkEditorCloudStorageDocument(ckEditorId);
  ...
  await createCollaborativeSession(ckEditorId, html);
}

export async function debugGetCkEditorCloudInfo() {
