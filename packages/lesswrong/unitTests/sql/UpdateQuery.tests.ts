  ...
  runTestCases([
    {
      ...
      expectedSql: 'UPDATE "TestCollection" SET "b" = $1::TEXT , "c" = $2::TEXT WHERE "a" = $3',
    ...
    },
    {
      ...
      expectedSql: 'UPDATE "TestCollection" SET "c" = $1::TEXT , "b" = $2 WHERE "a" = $3',
    ...
    },
    {
      ...
      expectedSql: 'UPDATE "TestCollection" SET "b" = $1::TEXT WHERE "_id" = $2',
    ...
    },
    {
      ...
      expectedSql: 'UPDATE "TestCollection" SET "b" = $1::TEXT WHERE _id IN ( SELECT "_id" FROM "TestCollection" LIMIT $2 FOR UPDATE)',
      expectedArgs: ["test", 1],
    },
    {
      name: "can build update with limit and selector",
      getQuery: () => new UpdateQuery<DbTestObject>(testTable, {a: 3}, {$set: {b: "test"}}, {}, {limit: 1}),
      expectedSql: 'UPDATE "TestCollection" SET "b" = $1::TEXT WHERE _id IN ( SELECT "_id" FROM "TestCollection" WHERE "a" = $2 LIMIT $3 FOR UPDATE )',
    ...
    },
    {
      ...
      expectedSql: 'UPDATE "TestCollection" SET "b" = ARRAY_APPEND( "b" , $1::INTEGER ) WHERE "a" = $2',
      expectedArgs: [2, 3],
    },
    {
      name: "can build update with $inc",
      getQuery: () => new UpdateQuery<DbTestObject>(testTable, {a: 3}, {$inc: {a: 1}}),
      expectedSql: 'UPDATE "TestCollection" SET "a" = COALESCE( "a" , 0 ) + $1::INTEGER WHERE "a" = $2',
      expectedArgs: [1, 3],
    },
    {
      name: "can set a value inside a JSON blob",
      getQuery: () => new UpdateQuery<DbTestObject>(testTable, {a: 3}, {$set: {"c.d.e": "hello world"}}),
      expectedSql: `UPDATE "TestCollection" SET "c" = JSONB_SET( "c" , '{d, e}' , $1::TEXT , TRUE) WHERE "a" = $2`,
    ...
    },
    {
      ...
      expectedSql: `UPDATE "TestCollection" SET "b" = fm_add_to_set( "b" , $1::TEXT ) WHERE "a" = $2`,
      expectedArgs: ["hello world", 3],
    },
    {
