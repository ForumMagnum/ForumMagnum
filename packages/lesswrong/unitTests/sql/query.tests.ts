...
describe("Query", () => {
  runTestCases([
    ...
    },
    {
      ...
      expectedSql: 'CREATE TABLE "TestCollection" (_id VARCHAR(17) PRIMARY KEY , "a" REAL , "b" TEXT , "c" JSONB , "schemaVersion" REAL )',
      expectedArgs: [],
    },
    {
      name: "can build create table query with 'if not exists'",
      getQuery: () => new CreateTableQuery(testTable, true),
      expectedSql: 'CREATE TABLE IF NOT EXISTS "TestCollection" (_id VARCHAR(17) PRIMARY KEY , "a" REAL , "b" TEXT , "c" JSONB , "schemaVersion" REAL )',
      expectedArgs: [],
    },
    {
