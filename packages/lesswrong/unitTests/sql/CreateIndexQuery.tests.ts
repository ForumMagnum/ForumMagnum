  ...
  runTestCases([
    {
      ...
      getQuery: () => new CreateIndexQuery({ table: testTable, index: testTable.getIndexes()[0] }),
    ...
    },
    {
      ...
      getQuery: () => new CreateIndexQuery({ table: testTable, index: testTable.getIndexes()[1] }),
    ...
    },
    {
      ...
      getQuery: () => new CreateIndexQuery({ table: testTable, index: testTable.getIndexes()[2] }),
    ...
    },
    {
      ...
      getQuery: () => new CreateIndexQuery({ table: testTable, index: testTable.getIndexes()[3] }),
    ...
    },
    {
      ...
      getQuery: () => new CreateIndexQuery({ table: testTable, index: testTable.getIndexes()[4] }),
    ...
    },
    {
      ...
      getQuery: () => new CreateIndexQuery({ table: testTable, index: testTable.getIndexes()[5] }),
