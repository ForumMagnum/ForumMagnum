...
importComponent("SequencesRowItem", () => require('../components/sequences/SequencesRowItem'));
importComponent("SequencesRowItemList", () => require('../components/sequences/SequencesRowItemList'));
