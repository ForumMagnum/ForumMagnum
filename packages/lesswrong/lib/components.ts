...
importComponent("FrontPageFeedSection", () => require('../components/recentDiscussion/FrontPageFeedSection'));
importComponent("FrontPageFeedOptions", () => require('../components/recentDiscussion/FrontPageFeedOptions'));
