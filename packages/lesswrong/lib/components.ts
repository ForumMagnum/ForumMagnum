...
if (forumTypeSetting.get() === 'EAForum') {
  ...
  importComponent("EAHomeFrontpageSection", () => require('../components/ea-forum/EAHomeFrontpageSection'));
...
importComponent("BookPostsItem", () => require('../components/posts/BookPostsItem.tsx'));
