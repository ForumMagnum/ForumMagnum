...
importComponent("SubforumCentralFeed", () => require('../components/tagging/SubforumCentralFeed'));
...
importComponent("SubforumSubscribeOrCommentSection", () => require('../components/tagging/SubforumSubscribeOrCommentSection'));
