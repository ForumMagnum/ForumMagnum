...
importComponent("TagLinkpostBody", () => require('../components/tagging/TagLinkpostBody'));
importComponent("TagLinkpostSupplementalComments", () => require('../components/tagging/TagLinkpostSupplementalComments'));
