...
importComponent("SmallPingbacksList", () => require('../components/posts/SmallPingbacksList'));
...
importComponent("ReviewFullDashboard", () => require('../components/review/ReviewFullDashboard'))
importComponent("ReviewFullDashboardRow", () => require('../components/review/ReviewFullDashboardRow'))
