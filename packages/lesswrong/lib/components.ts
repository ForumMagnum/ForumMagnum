...
importComponent("PostFooterPostLink", () => require('../components/posts/PostFooterPostLink'));
...
importComponent(["FormComponentDateTime","ReactDateTime"], () => require('../components/form-components/FormComponentDateTime'));
...
importComponent(["RecommendationsExperimentationPage","RecommendationsExperimentSettingsPicker","PostSamplingAlgorithmPicker"], () => require('../components/recommendations2/RecommendationsExperimentationPage'));
importComponent("RecommendationsRubric", () => require('../components/recommendations2/RecommendationsRubric'));
importComponent(["WeightedPostsList","WeightedPostsListEditorItem"], () => require('../components/recommendations2/WeightedPostsList'));
importComponent(["RecommendationExperimentListItem","RecommendationExperimentFeedItem"], () => require('../components/recommendations2/RecommendationExperimentResult'));
