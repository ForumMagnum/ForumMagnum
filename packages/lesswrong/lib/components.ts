...
importComponent("EditPaymentInfo", () => require('../components/payments/EditPaymentInfo'));
importComponent("PostsPageDonationButton", () => require('../components/payments/PostsPageDonationButton'));
