...
- npm run repl -- prod packages/lesswrong/server/reviewVoteUpdate.ts 'updateReviewVoteTotals('finalVote')'
- npm run repl -- prod packages/lesswrong/server/reviewVoteUpdate.ts 'createVotingPostHtml()' 
...
3. Create Spotlights
- npm run repl -- prod packages/lesswrong/server/scripts/generativeModels/autoSpotlight.ts 'createSpotlights()' 
...
export const getReviewPhaseEnd = (reviewYear: ReviewYear) => moment.utc(`${reviewYear+2}-01-21`).add(TIMEZONE_OFFSET, 'hours')
