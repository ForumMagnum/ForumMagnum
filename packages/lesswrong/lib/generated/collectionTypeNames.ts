...
export const collectionNameToTypeName = {
  ...
  Reports: 'Report',
  ResearchConversationEvents: 'ResearchConversationEvent',
  ResearchConversations: 'ResearchConversation',
  ResearchDocuments: 'ResearchDocument',
  ResearchEnvironments: 'ResearchEnvironment',
  ResearchProjects: 'ResearchProject',
  ResearchSandboxSessions: 'ResearchSandboxSession',
  ReviewVotes: 'ReviewVote',
  ReviewWinnerArts: 'ReviewWinnerArt',
  ReviewWinners: 'ReviewWinner',
  RevisionOriginalContents: 'RevisionOriginalContent',
  Revisions: 'Revision',
  RSSFeeds: 'RSSFeed',
  SandboxBaselineSnapshots: 'SandboxBaselineSnapshot',
  Sequences: 'Sequence',
  Sessions: 'Session',
...
export const typeNameToCollectionName = {
  ...
  Report: 'Reports',
  ResearchConversationEvent: 'ResearchConversationEvents',
  ResearchConversation: 'ResearchConversations',
  ResearchDocument: 'ResearchDocuments',
  ResearchEnvironment: 'ResearchEnvironments',
  ResearchProject: 'ResearchProjects',
  ResearchSandboxSession: 'ResearchSandboxSessions',
  ReviewVote: 'ReviewVotes',
  ReviewWinnerArt: 'ReviewWinnerArts',
  ReviewWinner: 'ReviewWinners',
  RevisionOriginalContent: 'RevisionOriginalContents',
  Revision: 'Revisions',
  RSSFeed: 'RSSFeeds',
  SandboxBaselineSnapshot: 'SandboxBaselineSnapshots',
  Sequence: 'Sequences',
  Session: 'Sessions',
...
export const tableNameToCollectionName = {
  ...
  reports: 'Reports',
  researchconversationevents: 'ResearchConversationEvents',
  researchconversations: 'ResearchConversations',
  researchdocuments: 'ResearchDocuments',
  researchenvironments: 'ResearchEnvironments',
  researchprojects: 'ResearchProjects',
  researchsandboxsessions: 'ResearchSandboxSessions',
  reviewvotes: 'ReviewVotes',
  reviewwinnerarts: 'ReviewWinnerArts',
  reviewwinners: 'ReviewWinners',
  revisionoriginalcontents: 'RevisionOriginalContents',
  revisions: 'Revisions',
  rssfeeds: 'RSSFeeds',
  sandboxbaselinesnapshots: 'SandboxBaselineSnapshots',
  sequences: 'Sequences',
  sessions: 'Sessions',
