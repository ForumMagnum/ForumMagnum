...
interface cronHistoryDefaultFragment { // fragment on cronHistory
  readonly _id: string,
...
interface FragmentTypes {
  ...
  cronHistoryDefaultFragment: cronHistoryDefaultFragment
