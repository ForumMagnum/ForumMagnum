...
import {redirect} from './vulcan-accounts/helpers';
...
const lw18ReviewPosts = [
  ...
  ['babble2', 'bBdfbWfWxHN9Chjcq', 'wQACBmK5bioNCgDoG'],
  ['prune', 'bBdfbWfWxHN9Chjcq', 'rYJKvagRYeDM8E9Rf'],
  ...
  ['pavlov', '3rxMBRCYEmHCNDLhu', ''],
  ['commons', '2G8j8D5auZKKAjSfY', ''],
