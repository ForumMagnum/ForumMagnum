...
export const routePingbackMapping = {
  ...
  '/about': (parsedUrl, context) => getPostPingbackById(parsedUrl, aboutPostIdSetting.get(context)),
  '/contact': (parsedUrl, context) => getPostPingbackById(parsedUrl, contactPostIdSetting.get(context)),
  '/faq': (parsedUrl, context) => getPostPingbackById(parsedUrl, faqPostIdSetting.get(context)),
