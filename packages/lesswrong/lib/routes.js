...
addRoute({ name: 'Rationality.post.single', path: '/rationality/:slug', componentName: 'PostsSingleSlugWrapper'})

addRoute({ name: 'HPMOR', path: '/hpmor', componentName: 'HPMOR'})
addRoute({ name: 'HPMOR.post.single', path: '/hpmor/:slug', componentName: 'PostsSingleSlugWrapper'})

addRoute({ name: 'Codex', path: '/codex', componentName: 'Codex'})
addRoute({ name: 'Codex.post.single', path: '/codex/:slug', componentName: 'PostsSingleSlugWrapper'})
