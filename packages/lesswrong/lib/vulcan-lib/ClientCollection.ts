import { getVoteableSchemaFields } from "@/lib/lib/make_voteable";
class ClientCollection<N extends CollectionNameString = CollectionNameString> implements CollectionBase<N> {
    collectionName: N;
    tableName: string;
