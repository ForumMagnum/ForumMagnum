...
export type Route = {
  ...
  //
  // This should only return true for routes which are guaranteed to be valid. I.e. it
  // is better to give false negatives (not prefetching on a route that actually returns
