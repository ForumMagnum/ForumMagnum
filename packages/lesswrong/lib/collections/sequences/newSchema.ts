...
const schema = {
  ...
  // Cloudinary image id for the portrait (~3:4) book-cover image. Optional;
  // where absent, UI falls back to a cropped gridImageId/bannerImageId.
  coverImageId: {
    database: {
      type: "TEXT",
    },
  ...
  // /library page derives sequence tags from post tags via libraryTags
  // below); collections still use their own libraryTopic field.
  libraryTopic: {
    database: {
      type: "TEXT",
    },
