...
const fetchMentionableSuggestions = async (forumType: ForumTypeString, searchString: string) => {
...
export const mentionPluginConfiguration = (portalContext: CkEditorPortalContextType|null, forumType: ForumTypeString) => ({
  feeds: [
    {
      marker: MARKER,
