...
export const namesAttachedReactions: NamesAttachedReactionType[] = [
  ...
  },
  {
    name: "goodpoint",
    label: "Good point!",
    searchTerms: ["lightbulb", "good", "point", "insight"],
    svg: "/reactionImages/nounproject/lightbulb.svg",
    description: (contentType) => `This ${contentType} makes a good point`,
  },
  {
    name: "changemind",
 ...
 //Here begins the list of deprecated reacts 
  ...
  },
  {
    ...
    filter: {opacity: 0.7, scale: 1.4, translateY: 2.5},
    description: ""
  },
  {
    name: "confused",
  ...
  },
  {
    ...
    searchTerms: ["resolved", "question", "confusion", "clear", "understood"],
  ...
  },
  {
    ...
    searchTerms: ["bet", "betting", "wager", "challenge"],
    svg: "/reactionImages/nounproject/bet.svg",
    filter: {opacity: 0.8, scale: 1.2},
  ...
  },
  {
    ...
    searchTerms: ["agree", "denotation", "disagree", "connotation", "subtext", "meaning"],
