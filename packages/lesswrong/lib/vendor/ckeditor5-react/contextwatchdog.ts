...
type ArrayOrItem<T> = any; type CKEditorError = any;

import Watchdog from './watchdog';
import type { WatchdogConfig, WatchdogState } from './watchdog';
import EditorWatchdog from './editorwatchdog';
import type { EditorCreatorFunction } from './editorwatchdog';
