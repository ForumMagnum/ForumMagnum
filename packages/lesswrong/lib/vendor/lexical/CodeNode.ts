 ...
 *
 * Vendored from:
 * https://raw.githubusercontent.com/facebook/lexical/refs/heads/main/packages/lexical-code-core/src/CodeNode.ts
 */
  ...
  insertNewAfter(
    ...
    if ($isTextNode(firstSelectionNode)) {
      let node: null | LexicalNode =
        $getFirstCodeNodeOfLine(firstSelectionNode as CodeHighlightNode | TabNode);
      const insertNodes = [];
