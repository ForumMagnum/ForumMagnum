...
import { hasCommentsTableOfContentSetting, hasDialoguesSetting, hasPostInlineReactionsSetting, hasSideCommentsSetting, isLW, isLWorAF, testServerSetting, userIdsWithAccessToLlmChat } from './instanceSettings';
...
export const userCanEditTagPortal: BetaGate = (user) => adminOnly(user);
...
export const userHasNewTagSubscriptions: BetaGate = (user) => disabled(user);
export const userHasDefaultProfilePhotos = disabled

export const userHasAutosummarize = adminOnly

export const userHasThemePicker: BetaGate = (user) => shippedFeature(user);
...
export const allowSubscribeToSequencePosts = () => false;
/** On the post page, do we show users other content they might want to read */
export const hasPostRecommendations = () => false;
 ...
 */
export const hasTwitterFeatures = () => false;
...
export const hasForumEvents = () => false;
export const hasSurveys = () => false;
...
export const hasSubforums = () => false;
export const hasPolls = () => false;
...
export const hasAuthorModeration = () => true;
