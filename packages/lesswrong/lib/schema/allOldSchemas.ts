...
export function getSimpleSchema<N extends CollectionNameString>(collectionName: N): OldSimpleSchemaType<N> {
  return allSimpleSchemas[collectionName] as OldSimpleSchemaType<N>;
}
