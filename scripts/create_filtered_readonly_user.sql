...
SELECT 	"_id", "username", "emails", "email", "isAdmin", "displayName", "slug",
	...
	"hiddenPostsMetadata", "legacyId", "deleted", "voteBanned", "nullifyVotes",
	...
	"maxCommentCount", "tagRevisionCount", "abTestKey", "abTestOverrides",
	...
	"linkedinProfileURL", "facebookProfileURL", "twitterProfileURL",
	...
	"schemaVersion", "createdAt", "moderationGuidelines",
