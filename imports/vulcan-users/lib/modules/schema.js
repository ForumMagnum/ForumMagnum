...
import { Utils, getCollection, Connectors, Locales } from 'vulcan:lib'; // import from vulcan:lib because vulcan:core isn't loaded yet
  ...
  */
  email: {
    ...
    onCreate: ({ document: user }) => {
      ...
      if (meteorEmails) return _.find(meteorEmails, { primary: true }).address;
