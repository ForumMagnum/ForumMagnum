...
export {
  NamesAttachedReactionsVoteOnCommentComponent as NamesAttachedReactionsVoteOnComment,
  NamesAttachedReactionsCommentBottomComponent as NamesAttachedReactionsCommentBottom
}
