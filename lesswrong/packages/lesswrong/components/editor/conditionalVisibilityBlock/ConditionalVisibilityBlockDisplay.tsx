...
import ShowBlockVisibilityCondition from "@/components/editor/conditionalVisibilityBlock/ShowBlockVisibilityCondition";
...
export default ConditionalVisibilityBlockDisplayComponent;
