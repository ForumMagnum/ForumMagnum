...
--
-- Overall schema hash: 63681e65be180e252867b6970b52fcda

-- Accepted on 2022-10-21T09:19:15.000Z by 20221021T091915.auto.ts

-- Schema for "AdvisorRequests", hash: 5c4842ba45559915e1920a62103dd27f
...
-- Schema for "Comments", hash: 1c7d9f7e6f849972d88b0385a408d69d
...
-- Schema for "GardenCodes", hash: 0951092a2230d2c060faf549081112f7
...
-- Schema for "Posts", hash: f6a2f1731dbc3c5ed69e3d9748e44984
CREATE TABLE "Posts" (
    _id varchar(27) PRIMARY KEY,
    "postedAt" timestamptz,
...
-- Schema for "Tags", hash: 3944a6ff4faad97c30e35c3b0c76ad0a
CREATE TABLE "Tags" (
    _id varchar(27) PRIMARY KEY,
    "name" text,
    "slug" text,
...
-- Schema for "Users", hash: 5a93c4097f9fa795380ecb6123ae6e8a
CREATE TABLE "Users" (
    _id varchar(27) PRIMARY KEY,
    "username" text,
    "emails" jsonb[],
