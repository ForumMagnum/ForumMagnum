...
--
-- Overall schema hash: ab02d7ee110cc11f4df3b0f16a24905d

-- Accepted on 2023-10-06T19:31:46.000Z by 20231006T193146.dialogue_notifications_and_post_sharing_default.ts
...
-- Schema for "Users", hash: 967045918e21d34c509811d70bf4f002
CREATE TABLE "Users" (
    _id varchar(27) PRIMARY KEY,
    "username" text,
    "emails" jsonb[],
    ...
    "notificationDialogueMessages" jsonb DEFAULT '{"channel":"onsite","batchingFrequency":"realtime","timeOfDayGMT":12,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationPublishedDialogueMessages" jsonb DEFAULT '{"channel":"onsite","batchingFrequency":"daily","timeOfDayGMT":12,"dayOfWeekGMT":"Monday"}' ::jsonb,
