...
--
-- Overall schema hash: 30d84b9a54a96c833c08b9783ea18d26
...
-- Custom index, hash: 8d84d1d683c7ba790bc6cbf282331b66
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_Users_tsvector_jobTitle" ON "Users" (TO_TSVECTOR('english', "jobTitle"))
WHERE
...
-- Custom index, hash: 514de7080f9a81f9c9e4b237a81235b2
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_Users_tsvector_organization" ON "Users" (TO_TSVECTOR('english', "organization"))
WHERE
...
-- Custom index, hash: 7e8234b5f47cb5b1a45f3fa047f5d359
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_Users_tsvector_mapLocationAddress" ON "Users" (TO_TSVECTOR('english', "mapLocation" ->> 'formatted_address'))
WHERE
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_Comments_postId_promotedAt" ON "Comments" ("postId", "promotedAt")
WHERE
    "promotedAt" IS NOT NULL;

-- Custom index, hash: 0ccdd8c2f93f3ca1c32ea682c508f2cd
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_Comments_userId_postId_postedAt" ON "Comments" ("userId", "postId", "postedAt");

-- Custom index, hash: 6f7b39d4fe238561f4ecb74684ce1179
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_comments_popular_comments ON "Comments" ("postId", "baseScore" DESC, "postedAt" DESC)
WHERE ("baseScore" >= 15);
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_Posts_max_postedAt_mostRecentPublishedDialogueResponseDate" ON "Posts" (GREATEST ("postedAt", "mostRecentPublishedDialogueResponseDate") DESC)
WHERE
    "collabEditorDialogue" IS TRUE;

-- Custom index, hash: 8c29ba22c8be83917dc4b19b6256df26
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_Users_subscribed_to_curated" ON "Users" USING btree ("emailSubscribedToCurated", "unsubscribeFromAll", "deleted", "email", "_id")
WHERE
