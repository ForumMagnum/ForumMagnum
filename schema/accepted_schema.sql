...
--
-- Overall schema hash: 778fab1f7c2d942253123778b67715c5

-- Accepted on 2023-01-19T20:28:10.000Z by 20230119T202810.user_mentions_newMentionNotifictions.ts
...
-- Schema for "Comments", hash: 9b9741619434a020795c555b50d5124d
...
-- Schema for "Images", hash: 2b927159b8ef1fd9f990db217884cf4e
CREATE TABLE "Images" (
    _id varchar(27) PRIMARY KEY,
    "originalUrl" text,
    "cdnHostedUrl" text,
...
-- Schema for "Spotlights", hash: 2af5c7fd81cd7d37b5b1b1b5523f7a55
...
-- Schema for "Tags", hash: a6ac7f07ec187f740dbca8d52a95b9af
CREATE TABLE "Tags" (
    _id varchar(27) PRIMARY KEY,
    "name" text,
    "slug" text,
...
-- Schema for "Users", hash: 500a829a95f4ca42ae56812eecc03540
CREATE TABLE "Users" (
    _id varchar(27) PRIMARY KEY,
    "username" text,
    "emails" jsonb[],
