...
--
-- Overall schema hash: 667918b4902ffa771fab9bbc2aef860e

-- Accepted on 2024-04-08T15:56:40.000Z by 20240408T155640.add_people_directory.ts
...
-- Schema for "Users", hash: 16cc25f168bc4adddf04ac4d64c51c62
CREATE TABLE "Users" (
    _id varchar(27) PRIMARY KEY,
    "username" text,
    "emails" jsonb[],
...
-- Function, hash: ac11eaf58c44cb33e7b863bd21d621f4
CREATE OR REPLACE FUNCTION fm_get_user_profile_updated_at(userid TEXT)
    RETURNS TIMESTAMPTZ LANGUAGE sql AS $$
      SELECT COALESCE(
        ...
        WHERE "key" IN ('username', 'displayName', 'organizerOfGroupIds', 'programParticipation', 'googleLocation', 'location', 'mapLocation', 'profileImageId', 'jobTitle', 'organization', 'careerStage', 'website', 'biography', 'howOthersCanHelpMe', 'howICanHelpOthers', 'linkedinProfileURL', 'facebookProfileURL', 'twitterProfileURL', 'githubProfileURL', 'profileTagIds')
