...
--
-- Overall schema hash: f0325d4a6f4663b8adc5f2ccf84737e6

-- Accepted on 2023-02-03T01:13:41.000Z by 20230203T011341.add_eloRatings_field.ts
...
-- Schema for "Comments", hash: a311f752d0cfb4e25f2a4f49ddaa8822
...
-- Schema for "DebouncerEvents", hash: d4149cf592b394fd4e46b80d73e6bfd2
...
-- Schema for "PostComparisons", hash: 7b81970b69dc286f24bb01bdc063cd3e
CREATE TABLE "PostComparisons" (
    _id varchar(27) PRIMARY KEY,
    "postIds" text[],
    "rankings" jsonb,
    "userId" varchar(27),
...
-- Schema for "Posts", hash: 76e00ece0eb585e14eb50e56abb3d819
CREATE TABLE "Posts" (
    _id varchar(27) PRIMARY KEY,
    "postedAt" timestamptz,
...
-- Schema for "RecommendationLogs", hash: 4c8aecc018653197cc67095279b85b47
...
-- Schema for "TagRels", hash: d9cede963afb3483b12f7bc16f64d659
...
-- Schema for "UserPostEngagements", hash: 578421dc57fcb90e24f3b7e30152783a
CREATE TABLE "UserPostEngagements" (
    _id varchar(27) PRIMARY KEY,
    "postId" varchar(27),
    "clientId" text,
    "userId" varchar(27),
    "referralType" text,
    "referralRecommendation" varchar(27),
    "readingTimeMS" double precision DEFAULT 0,
