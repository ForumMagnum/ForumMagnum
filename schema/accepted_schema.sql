...
--
-- Overall schema hash: 0af380ba7653c0b38ee38230eee77fb9

-- Accepted on 2024-09-18T20:38:01.000Z by 20240918T203801.create_DoppelComments_and_DoppelCommentVotes_tables.ts
...
-- Table "DoppelCommentVotes", hash 4f8a06b5ab09acba08b2da28cac5af5a
CREATE TABLE "DoppelCommentVotes" (
  _id VARCHAR(27) PRIMARY KEY,
  "userId" VARCHAR(27) NOT NULL,
  "commentId" VARCHAR(27),
  "type" TEXT NOT NULL,
  "doppelCommentChoiceId" VARCHAR(27),
  "deleted" BOOL NOT NULL DEFAULT FALSE,
  "schemaVersion" DOUBLE PRECISION NOT NULL DEFAULT 1,
  "createdAt" TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP NOT NULL,
  "legacyData" JSONB
...
-- Index "idx_DoppelCommentVotes_schemaVersion", hash 125130249733fd03af28f551214f4b1c
CREATE INDEX IF NOT EXISTS "idx_DoppelCommentVotes_schemaVersion" ON "DoppelCommentVotes" USING btree ("schemaVersion");

-- Index "idx_DoppelCommentVotes_userId_commentId", hash 61fa48e8e33a896c1278dc67a5185602
CREATE UNIQUE INDEX IF NOT EXISTS "idx_DoppelCommentVotes_userId_commentId" ON "DoppelCommentVotes" USING btree ("userId", COALESCE("commentId", ''));

-- Table "DoppelComments", hash efea1609ec19913d988c9decf6a7158c
CREATE TABLE "DoppelComments" (
  _id VARCHAR(27) PRIMARY KEY,
  "commentId" VARCHAR(27) NOT NULL,
...
-- Index "idx_DoppelComments_schemaVersion", hash b4b87b9d5053c1a4fb2999532feed802
CREATE INDEX IF NOT EXISTS "idx_DoppelComments_schemaVersion" ON "DoppelComments" USING btree ("schemaVersion");

-- Index "idx_DoppelComments_commentId_deleted_createdAt", hash 4267266f50feaa0ad1d9f03199fd5cd3
CREATE INDEX IF NOT EXISTS "idx_DoppelComments_commentId_deleted_createdAt" ON "DoppelComments" USING btree ("commentId", "deleted", "createdAt");
