...
--
-- Overall schema hash: 9e733b575316b2cdd41d3a1d9032131a

-- Accepted on 2022-12-13T15:39:54.000Z by 20221213T153954.array_of_foreign_key_defaults.ts
...
-- Schema for "Books", hash: ab2894d6d05584bd30dfd4e2d16a9dda
CREATE TABLE "Books" (
    _id varchar(27) PRIMARY KEY,
...
-- Schema for "Chapters", hash: 9dcdc84caafc9c0d3639e6afbcdb4c9a
...
-- Schema for "Comments", hash: 6a358c8a4f12c831871b8d78ef9b9098
...
-- Schema for "Conversations", hash: 03d59fcb881ade3f7cd74a9eadad3a1d
...
-- Schema for "Localgroups", hash: 32514f9e23e3227513c6000044787cc4
...
-- Schema for "Migrations", hash: 05f0b22235a44811580459e3f7179e16
...
-- Schema for "Posts", hash: 47bbb1df6f3baa9e5ee2479fbb79b4f9
CREATE TABLE "Posts" (
    _id varchar(27) PRIMARY KEY,
    "postedAt" timestamptz,
...
-- Schema for "Tags", hash: 3aa8af1b912a9d4d299e19804d355968
CREATE TABLE "Tags" (
    _id varchar(27) PRIMARY KEY,
    "name" text,
    "slug" text,
...
-- Schema for "Users", hash: 0348a80cafdb0ff8219b7ef2bfc41e12
CREATE TABLE "Users" (
    _id varchar(27) PRIMARY KEY,
    "username" text,
    "emails" jsonb[],
